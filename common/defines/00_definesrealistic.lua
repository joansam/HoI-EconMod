...
NCountry = {
	...
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.04,  -- accessible recruitable factor base
	...
	MIN_MANPOWER_RATIO = 0.1,						-- Min manpower ratio to show manpower alert
...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 3.75, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_NAV = 1.875, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	...
	PRODUCTION_RESOURCE_LACK_PENALTY = -0.15,			-- Penalty decrease while lack of resource per factory
